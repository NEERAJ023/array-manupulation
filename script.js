...
function addData() {
  ...
  let ages=Number(prompt("Enter a age"));
  let professions=prompt("Enter a profession");
  if(!names|| isNaN(ages) || !professions){
    alert("please enter a valid context");
    return;
  }
  data.push({name:names, age:ages, profession:professions})
  console.log(data);
}
